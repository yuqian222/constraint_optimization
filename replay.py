...
def main():
    ...
    for i_episode in count(1):
        ...
        while num_steps < 15000:
            ...
            for t in range(1000): #short trejectories
                if num_steps < 6000:
                    ...
                    sample_policy.saved_action[-1] = action #update action
        ...
        best_tuples += low_rew_constraints_set #together
        ...
        for branch in range(BRANCHES):
            ...
            branch_policy.train(states,actions, epoch=1500)
